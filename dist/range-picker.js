...
angular
    .module('rgkevin.datetimeRangePicker', ['vr.directives.slider'])
    .filter('rgTime', [function() {
        /**
         * input should be a number of minutes to be parsed
         *
         * @param {input} input - number of minutes
         * @param {type} type - true = 00:00:00 | false = 00:00 am or pm
         */
    ...
    .directive('rgRangePicker', ['$compile', '$timeout', '$filter', function($compile, $timeout, $filter) {
        ...
        return {
            ...
            link: function(scope, element, attrs) {
                ...
                var timeChangePromise;

                scope.data.hasDatePickers = angular.isObject(scope.data.date);
                scope.data.hasTimeSliders = angular.isObject(scope.data.time);
                // set labels for date pickers
                scope.datepickerTitles = angular.extend(defaultLabels.date, scope.labels && scope.labels.date);
